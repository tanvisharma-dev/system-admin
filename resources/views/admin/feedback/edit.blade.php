...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Edit Feedback Form</h6>
        </div>
        <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('student_id') is-invalid @enderror" id="student_id" name="student_id" required>
                                ...
                                @foreach($students as $student)
                                    <option value="{{ $student->id }}" {{ old('student_id', $feedback->student_id) == $student->id ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('seminar_id') is-invalid @enderror" id="seminar_id" name="seminar_id" required>
                                ...
                                @foreach($seminars as $seminar)
                                    <option value="{{ $seminar->id }}" {{ old('seminar_id', $feedback->seminar_id) == $seminar->id ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('rating') is-invalid @enderror" id="rating" name="rating" required>
                                ...
                                @foreach($ratings as $rating)
                                    <option value="{{ $rating }}" {{ old('rating', $feedback->rating) == $rating ? 'selected' : '' }}>
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('feedback_text') is-invalid @enderror" id="feedback_text" name="feedback_text" rows="5" required>{{ old('feedback_text', $feedback->feedback_text) }}</textarea>
                            @error('feedback_text')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
