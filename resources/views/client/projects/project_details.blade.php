...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div>
            ...
            <a href="{{ route('client.projects') }}" class="btn btn-secondary">
                                ...
                                <tbody>
                                    ...
                                    @foreach($project->paymentSchedules as $schedule)
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{ route('client.ModuleDetails',$schedule->id) }}" class="btn btn-sm btn-info text-white p-1 px-2 me-1"><i class="fas fa-eye"></i></a></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                                <tfoot>
